<div id="readArticleModal" tabindex="-1" aria-hidden="true"
...
<div class="relative p-4 w-full max-w-xl max-h-full">
    ...
    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        ...
        <div class="flex justify-between mb-4 rounded-t sm:mb-5">
            ...
            <div>
                <button type="button"
                    ...
                    data-modal-toggle="readArticleModal">
        ...
        <dl>
            ...
            <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ Str::limit($post->body, 150) }}</dd>
            <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Category</dt>
            <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $post->category->name }}</dd>
        </dl>
